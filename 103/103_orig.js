...
!(function(t) {
  var e = (function(e) {
    function i() {
      ...
      return (t.reward_state = 0), (i.Inst = t), t;
    }
    return (
      __extends(i, e),
      ...
      (i.prototype.show = function(e, i, n) {
        ...
        if (5 == r.matrix_x || 5 == r.matrix_y) {
          (this.contianer_tasks.visible = !1), (this.label_info.visible = !0);
          var s = 0;
          5 == r.matrix_x && (s += 1),
            5 == r.matrix_y && (s += 2),
        ...
        (this.btn_confirm.visible = 1 != i), (this.btn_get.visible = 1 == i);
        for (
          var l = r.reward.split(','),
            ...
            c = function(e) {
              ...
              if (e < l.length) {
                ...
                (s.text = r.toString()), (s.visible = r > 1);
