    ...
    return (
      ...
      (i.prototype.getShowedChoose = function() {
        ...
        if (game.Tools.CannotPay())
          return (a.visible = !1), (n.visible = !0), (i.visible = !0), [i, n];
        var r = [];
        if (
      ...
      (i.prototype.show = function(e) {
        ...
        (this.label_title.text = n.name),
          (this.label_desc.text =
            t.UI_Activity_Yueka.GetYuekaLeftDays(this.goods_id) >= 0
              ? n.desc_detail2
              : n.desc_detail),
        ...
        if (((a.vScrollBarSkin = ''), r.length <= 2))
          for (s = 0; s < r.length; s++) r[s].y = 50 + 144 * s;
        else for (var s = 0; s < r.length; s++) r[s].y = 144 * s;
        (a.vScrollBar.value = 0), a.refresh();
      }),
