      ...
      function e(t) {
        (this.me = t),
          ...
          (this.btn_dajiangsai.clickHandler = Laya.Handler.create(
            this,
            function() {
              GameMgr.Inst.BehavioralStatistics(3), h.Inst.setPage(3);
            },
            null,
            !1
          ));
        ...
        (e.prototype.onEnable = function(e) {
          ...
          if (t.UI_Activity.activity_is_running(a.activity_id)) {
            var r = Laya.LocalStorage.getItem(
              ...
              s = 0;
            r && '' != r && (s = parseInt(r)), (n = Date.now() > s + 864e6);
          }
      ...
      return (
        (e.prototype.show = function() {
          ...
          for (var i = 0; i < this.btns.length; i++)
            if (i < this.infos.length) {
              (this.btns[i].alpha = 1), (this.btns[i].visible = !0);
        ...
        (e.prototype.onClickAt = function(e) {
          ...
          if ('dahuishi' == i) {
            ...
            (g = !0) &&
              !n.is_open &&
              ((g = !1), (r = game.Tools.strOfLocalization(1306)));
            var s = !0,
              o = !0,
              l = !0,
              c = !0,
              ...
              100 == t.room &&
                ...
                t.mode < 10
                  ? ((!t.level_limit || d >= t.level_limit) && (s = !1),
                    (!t.level_limit_ceil || d <= t.level_limit_ceil) &&
                      (o = !1))
                  : ((!t.level_limit || f >= t.level_limit) && (l = !1),
                    (!t.level_limit_ceil || f <= t.level_limit_ceil) &&
                      (c = !1)));
            }),
              (s || o) && (l || c)
                ? ((g = !1), (r = game.Tools.strOfLocalization(103)))
                : u
                ? ((g = !1), (r = game.Tools.strOfLocalization(101)))
                : _ && ((g = !1), (r = game.Tools.strOfLocalization(102))),
              g
                ? (this.close(),
                  Laya.timer.once(100, this, function() {
            ...
            cfg.desktop.matchmode.forEach(function(t) {
              100 == t.room &&
                ...
                t.mode < 10 &&
                  ...
                  (!t.level_limit_ceil || x <= t.level_limit_ceil) &&
                    (v = !1)));
            }),
              y || v
                ? ((g = !1), (r = game.Tools.strOfLocalization(103)))
                : b
                ? ((g = !1), (r = game.Tools.strOfLocalization(101)))
                : w && ((g = !1), (r = game.Tools.strOfLocalization(102))),
              g &&
                !m.is_open &&
                ((g = !1), (r = game.Tools.strOfLocalization(1306))),
              g
