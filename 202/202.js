        ...
        app.NetAgent.sendReq2Lobby(
          ...
          (e, {error, record_list, record_collect_limit}) => {
            if (e || error);
              ...
              if (record_list) {
                for (var n = record_list, a = 0; a < n.length; a++) {
                  var r = {
                    uuid: n[a].uuid,
                    time: n[a].end_time,
                    remarks: n[a].remarks
...
(v.getMonth() + 1).toString()}/`;
            ...
            if (s.collect_info[r.uuid]) {
              var M = s.collect_info[r.uuid],
                T = i.getChildByName('remarks_info'),
                L = i.getChildByName('input'),
                ...
                A = () => {
                  ...
                  M.remarks && '' != M.remarks
                        ? (T.text = game.Tools.strWithoutForbidden(M.remarks))
                        : (T.text = I);
              ...
              E.on('blur', this, () => {
                ...
                N &&
                  (game.Tools.calu_word_length(E.text) > 30
              ...
              B.getChildByName('img').skin = game.Tools.localUISrc(
              ...
              var B = i.getChildByName('collect');

              B.clickHandler = Laya.Handler.create(
                this,
                () => {
      ...
      onCollectChange(t, i) {
        s.paipuLst[e.COLLECT].removeAt(i);
