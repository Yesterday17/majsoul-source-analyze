...
!(t => {
  ...
  var i = (() => {
    class i {
      ...
      static fb_trace_pending(t, e) {
        if (this._datas && !(t < 0 || t > 100)) {
          var i = this._get_type_str(t);
          if ('unkown' != i) {
            var n = 0;
            this._datas[t] && (n = this._datas[t]);
            if ((n != e)) {
              for (var a = 0; a < e - n; a++)
      ...
      static google_trace_pending(t, e) {
