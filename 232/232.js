...
!(t => {
  ...
  var a = (() => {
    ...
    e.prototype.render_item = function({cache_data, index, container}) {
      cache_data;
      var i = this,
        n = index,
        a = container,
  ...
  var r = (() => {
    ...
    e.prototype.refresh_data = function(e) {
      ...
      r &&
        r.forEach(({chest_id, up_items}) => {
          if (chest_id == e)
            for (var n = up_items, a = 0; a < n.length; a++)
              i.in_up[n[a]] = 1;
        });
  ...
  var h = (i => {
    class n {
      ...
      static on_chest_count_change(t) {
      ...
      refresh_show() {
        ...
        game.LoadMgr.setImgSkin(this.img_head, s);
