    ...
    n = (function(n) {
      ...
      return (
        ...
        (a.prototype._showInfo_mj = function(e) {
          ...
          var n = view.DesktopMgr.Inst.player_datas[e.seat].character;
          ...
          for (var M = [], o = 0; o < e.fan_names.length; o++) {
            var T = e.fan_names[o],
              L = 0,
              E = e.fan_ids[o];
            9999 != E && (L = cfg.fan.fan.get(E).show_index);
            var D = { name: T, index: L };
            if (
              (e.fan_value &&
              ...
              var N = D.value;
              N > 13 && (N = 13), (D.sound = 0 == N ? '' : 'fan_dora' + N);
            } else
              9999 == E
                ? (D.sound = 'fan_liujumanguan')
                : E >= 0 && (D.sound = cfg.fan.fan.get(E).sound);
            M.push(D);
          }
          ...
          for (
            var A = function(t) {
                var e = game.Tools.get_chara_audio(n, M[t].sound);
                Laya.timer.once(C, B, function() {
                  ...
                  if (
                    ...
                    void 0 !== M[t].value && null !== M[t].value)
                  ) {
                    i.getChildAt(2).visible = !0;
                    var a = M[t].value.toString();
                    2 == a.length
          ...
          if (
            ...
            switch (e.title_id) {
              case mjcore.E_Dadian_Title.E_Dadian_Title_manguan:
                (P = 'gameend_manguan'), (R = 214);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_tiaoman:
                (P = 'gameend_tiaoman'), (R = 214);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_beiman:
                (P = 'gameend_beiman'), (R = 201);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_sanbeiman:
                (P = 'gameend_sanbeiman'), (R = 201);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_leijiyiman:
                (P = 'gameend_leijiyiman'), (k = 2), (R = 226);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_yiman:
                (P = 'gameend_yiman1'), (k = 1), (R = 226);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_yiman2:
                (P = 'gameend_yiman2'), (k = 2), (R = 226);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_yiman3:
                (P = 'gameend_yiman3'), (k = 2), (R = 226);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_yiman4:
                (P = 'gameend_yiman4'), (k = 2), (R = 226);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_yiman5:
                (P = 'gameend_yiman5'), (k = 2), (R = 226);
                break;
              case mjcore.E_Dadian_Title.E_Dadian_Title_yiman6:
                (P = 'gameend_yiman6'), (k = 2), (R = 226);
            }
            var O = game.Tools.get_chara_audio(n, P);
            Laya.timer.once(C, this, function() {
        ...
        (a.prototype._showInfo_record = function(t) {
          ...
          for (var x = [], a = 0; a < t.fan_names.length; a++) {
            ...
            var M = { name: I, index: S };
            t.fan_value && t.fan_value.length > a && (M.value = t.fan_value[a]),
              x.push(M);
          }
          ...
          for (a = 0; a < b && a < w.numChildren; a++) {
            var T = w.getChildAt(a),
              L = T.getChildByName('l_name');
            if (
              ((L.text = x[a].name),
              (L.width = 242),
              game.Tools.labelLocalizationSize(L, 242, 0.8),
              void 0 !== x[a].value && null !== x[a].value)
            ) {
              T.getChildAt(2).visible = !0;
              var E = x[a].value.toString();
              2 == E.length
                ? ((T.getChildAt(3).skin = game.Tools.localUISrc(
                    'myres/mjdesktop/h_' + E[1] + '.png'
                  )),
                  (T.getChildAt(3).visible = !0),
                  (T.getChildAt(4).skin = game.Tools.localUISrc(
                    'myres/mjdesktop/h_' + E[0] + '.png'
                  )),
                  (T.getChildAt(4).visible = !0))
                : ((T.getChildAt(3).skin = game.Tools.localUISrc(
                    'myres/mjdesktop/h_' + E[0] + '.png'
                  )),
                  (T.getChildAt(3).visible = !0),
                  (T.getChildAt(4).visible = !1));
            }
            T.visible = !0;
          }
          (this.container_fan.visible = !1),
