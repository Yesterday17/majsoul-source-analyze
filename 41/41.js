      ...
      _OnConnent(e) {
        ...
        e == Laya.Event.CLOSE || e == Laya.Event.ERROR
          ? Laya.timer.currTimer - this.lasterrortime > 100 &&
            ((this.connect_state == t.EConnectState.tryconnect ? this._try_to_linknext() : this.connect_state == t.EConnectState.connecting
        ...
        app.NetAgent.sendReq2MJ(
          ...
          (i, n) => {
            ...
            if (i || n.error)
              ...
              var s = n.game_config.mode;
              view.ERuleMode.Liqi4;
              view.ERuleMode.Liqi4;
              view.ERuleMode.Liqi3;
              s.mode < 10
                ? (e.real_player_count = 4)
                : s.mode < 20 &&
