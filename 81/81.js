  ...
  var e = (e => {
    class i {
      ...
      static play(e) {
        ...
        var i = e.seat;
        var n = mjcore.MJPai.Create(e.tile);
        var a = !(null == e.is_liqi || void 0 == e.is_liqi || !e.is_liqi);
      ...
      static fastplay(e, i) {
        ...
        var n = e.seat;
        var a = mjcore.MJPai.Create(e.tile);
        var r = !(null == e.is_liqi || void 0 == e.is_liqi || !e.is_liqi);
