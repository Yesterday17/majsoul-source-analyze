    ...
    return (
      ...
      (r.prototype.initRoom = function(e, a, s, o, l) {
        ...
        for (u = 0; u < this.player_datas.length; u++) {
          ...
          if (b) {
            var w = b.views,
              x = 'scene/effect_hupai_default.lh',
              I = '',
              C = 'scene/liqi_default.lh',
              S = 'hand_human',
              M = '',
              T = 'scene/effect_mingpai_default.lh',
              L = cfg.item_definition.character.get(b.charid);
            if ((L && (S = L.hand), w))
      ...
      (r.prototype.ShowHuleEffect = function(e, i, n) {
        ...
        if (null != e) {
          ...
          var o = !1,
            l = e.model.parent,
            h = e.model.transform.rotation.clone(),
            c = e.model.transform.worldMatrix.clone();
          r.addLoadedListener(
            Laya.Handler.create(this, function() {
              if (!o) {
