...
!(t => {
  var e = (e => {
    class i {
      ...
      Hule(e, i, n, a) {
        var r = this;
        app.Log.log(`ViewPlayer_Me Hule ${i.toString()} zimo:${n}`);
        if (
          (n)
        ) {
          var s = new t.HandPai3D(this.trans_hand3D);
      ...
      onMouseMove() {
        if (
          ...
          var i = Laya.MouseManager.instance.mouseY;
      ...
      onMouseOut() {
        ...
        this.click_on_choosed = !1;
        this.during_drag = !1;
        this.during_drag && (this.resetMouseState());
      }
      ...
      getMouseInfo() {
        ...
        var o = Math.floor((r - this.handorigin_x) / this.handwidth);
        o < 0 && (o = 0);
        ...
        return { inHandRange: s < this.handrange_top, index: o, x: r, y: s, pai: l };
      }
