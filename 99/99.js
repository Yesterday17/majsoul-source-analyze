  ...
  var i = (i => {
    class n {
      ...
      static max_point() {
        ...
        cfg.activity.game_point.forEach(({activity_id, unlock_day, point}) => {
      ...
      haveRedPoint() {
        ...
        cfg.activity.game_point.forEach(({activity_id, point, id}) => {
