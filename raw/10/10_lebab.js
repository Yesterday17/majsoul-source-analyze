  ...
  const e = (() => {
    ...
    (t.prototype._nextchar = function() {
      ...
      if ('[' == this._info[this._index]) {
        ...
        this._index = t + 1;
        const i = Laya.timer.currTimer - this._start_time;
        i >= n
          ? this._nextchar()
        ...
        let a = this.info.text;
        const r = this._speed * this._speed_multi;
        let s = r;
        const o = t => ' ' != t && '\t' != t && '\r' != t && '\n' != t;
          ...
          for (
            ...
            if (o(this._info[this._index])) {
              for (
                ...
                l += this._info[e++];
              this.info.text = a;
              const h = this.info.textField.textHeight;
              this.info.text = `${a + l} `;
              const c = this.info.textField.textHeight;
              if ((a.length > 0 && h != c && (a += '\n'), l.length > s)) {
