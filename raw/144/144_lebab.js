...
!(t => {
  const e = (() => {
      ...
      (t.prototype.showCD = function(t, e) {
        ...
        (this.me.visible = true),
          ...
          Laya.timer.frameLoop(1, this, () => {
            const t = Laya.timer.currTimer - i._pre_time;
      ...
      (t.prototype._show = function() {
        const t = this._fix + this._add - this.timeuse;
        if (t <= 0)
        ...
        if (t != this._pre_sec) {
          if (((this._pre_sec = t), t > this._add)) {
            ...
            if (0 != this._add) {
              ...
              for (
                const n = this._add.toString(), i = 0;
  ...
  const i = (() => {
    ...
    (t.prototype._loop_refresh_delay = function() {
      ...
      if (
        ...
        const i = app.NetAgent.mj_network_delay;
    ...
    (t.prototype._loop_show = function() {
      if (game.MJNetMgr.Inst.connect_state != game.EConnectState.connecting)
        ...
        const t = app.NetAgent.mj_network_delay;
        this.me.skin =
          t < 300
  ...
  const a = (() => {
    ...
    return (t.prototype.initRoom = function() {
      const t = view.DesktopMgr.Inst.main_role_character_info, e = cfg.item_definition.character.find(t.charid);
      this.emos = [];
      for (i = 0; i < 9; i++)
    ...
    (t.prototype.render_item = function({index, container}) {
      const e = this, i = index, n = container, a = this.emos[i], r = n.getChildByName('btn');
  ...
  var r = (r => {
    function s() {
      const t = r.call(this, new ui.mj.desktopInfoUI()) || this;
    ...
    (s.prototype.onCreate = function() {
      ...
      const o = this.me.getChildByName('container_lefttop'), l = o.getChildByName('container_doras');
        ...
        (o.getChildByName(
          ...
          () => {
            if (r.label_md5.visible)
              ...
              const t = r;
              Laya.timer.once(5e3, r.label_md5, () => {
      ...
      for (var h = 0; h < 4; h++) {
        const c = this.me.getChildByName(`container_player_${h}`), u = {};
        (u.container = c),
                  ...
                  Laya.Handler.create(r, () => {
                    if (view.DesktopMgr.Inst.gameing) {
                      for (
                        ...
                        const i = view.DesktopMgr.Inst.player_datas[e];
                        i &&
                          null != i.account_id &&
                          0 != i.account_id &&
                          t++;
          ...
          if (view.DesktopMgr.double_click_pass) {
            ...
            if (_ + 300 > e) {
              if (t.UI_ChiPengHu.Inst.enable)
                ...
                let i = view.DesktopMgr.Inst.mainrole.can_discard;
    ...
    (s.prototype.onGameBroadcast = function(t) {
      ...
      const e = view.DesktopMgr.Inst.seat2LocalPosition(t.seat), i = JSON.parse(t.content);
    ...
    (s.prototype.onPlayerConnectionState = function(t) {
      ...
      if (
        ...
        const i = view.DesktopMgr.Inst.seat2LocalPosition(e);
    ...
    (s.prototype._initFunc = function() {
      ...
      const e = this._container_fun.getChildByName('btn_func'), i = this._container_fun.getChildByName('btn_func2');
      ...
      const n = this._container_fun.getChildByName('btn_autolipai'), a = this._container_fun.getChildByName('btn_autolipai2');
      ...
      const r = this._container_fun.getChildByName('btn_autohu'), s = this._container_fun.getChildByName('btn_autohu2');
      ...
      const o = this._container_fun.getChildByName('btn_autonoming'), l = this._container_fun.getChildByName('btn_autonoming2');
      ...
      const h = this._container_fun.getChildByName('btn_automoqie'), c = this._container_fun.getChildByName('btn_automoqie2');
    ...
    (s.prototype.noAutoLipai = function() {
      const t = this._container_fun.getChildByName('btn_autolipai');
      (view.DesktopMgr.Inst.auto_liqi = true), t.clickHandler.run();
    }),
    (s.prototype.resetFunc = function() {
      const t = Laya.LocalStorage.getItem('autolipai');
      let e = true;
      e = !t || '' == t || 'true' == t;
      const i = this._container_fun.getChildByName('btn_autolipai');
      this.refreshFuncBtnShow(i, e),
        Laya.LocalStorage.setItem('autolipai', e ? 'true' : 'false'),
        view.DesktopMgr.Inst.setAutoLiPai(e);
      const n = this._container_fun.getChildByName('btn_autohu');
      this.refreshFuncBtnShow(n, view.DesktopMgr.Inst.auto_hule);
      const a = this._container_fun.getChildByName('btn_autonoming');
      this.refreshFuncBtnShow(a, view.DesktopMgr.Inst.auto_nofulu);
      const r = this._container_fun.getChildByName('btn_automoqie');
    ...
    (s.prototype.initRoom = function() {
      ...
      if (
        ...
        const _ = view.DesktopMgr.Inst.game_config, d = game.Tools.get_room_desc(_);
    ...
    (s.prototype.refreshSeat = function(t) {
      ...
      for (let e = view.DesktopMgr.Inst.player_datas, i = 0; i < 4; i++) {
        const n = view.DesktopMgr.Inst.localPosition2Seat(i), a = this._player_infos[i];
    ...
    (s.prototype.refreshLinks = function() {
      view.DesktopMgr.Inst.seat;
      for (let t = 0; t < 4; t++) {
        const e = view.DesktopMgr.Inst.localPosition2Seat(t);
        view.DesktopMgr.Inst.mode == view.EMJMode.play
    ...
    (s.prototype.setBen = function(t) {
      t > 99 && (t = 99);
      const e = this.me.getChildByName('container_lefttop'), i = e.getChildByName('num_ben_0'), n = e.getChildByName('num_ben_1');
      t >= 10
    ...
    (s.prototype.setLiqibang = function(t) {
      t > 99 && (t = 99);
      const e = this.me.getChildByName('container_lefttop'), i = e.getChildByName('num_lizhi_0'), n = e.getChildByName('num_lizhi_1');
      t >= 10
        ? ((n.skin = game.Tools.localUISrc(
            `myres/mjdesktop/w_${(t % 10).toString()}.png`
          )),
    ...
    (s.prototype.shout = function(t, e, {avatar_id}) {
      app.Log.log(`shout:${t} type:${e}`);
      try {
        const n = this._player_infos[t], a = n.container_shout, r = a.getChildByName('img_content'), s = a.getChildByName('illust').getChildByName('illust');
        '' == e
          ? (r.visible = false)
          : ((r.visible = true),
          ...
          game.Tools.charaPart(avatar_id, s, 'half', n.illustrect, true);
        let o = 0, l = 0;
        switch (t) {
          case 0:
            (o = -105), (l = 0);
    ...
    (s.prototype.refreshFuncBtnShow = (t, e) => {
      const i = t.getChildByName('img_choosed');
      (t.getChildByName('out').color = e ? '#3bd647' : '#7992b3'),
        (i.visible = e);
    }),
    (s.prototype.onShowEmo = function(t, e) {
      const i = this._player_infos[t];
      if (0 == t || !i.headbtn.emj_banned) {
        const n = i.container_emo,
              a =
    ...
    (s.prototype.changeHeadEmo = function(t, e, i) {
      const n = view.DesktopMgr.Inst.seat2LocalPosition(t);
