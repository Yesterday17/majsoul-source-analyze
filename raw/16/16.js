  ...
  var e = (function() {
    function e(t) {
      ...
      (this.desktop_default = 305044),
        ...
        (this.btn_lobby_bg.clickHandler = new Laya.Handler(this, function() {
    ...
    return (
      ...
      (e.prototype.change_tab = function(e) {
        ...
        if (
          ...
          3 == e &&
            cfg.item_definition.item.forEach(function(n) {
              n.id != i.lobby_bg_default &&
                5 == n.category &&
                3 == n.type &&
                (i.items.push({
                  item_id: n.id,
                ...
                n.id == game.GameUtility.get_common_view_id(e) &&
        ...
        if (
          ...
          if (0 != this.select_index) {
            i =
              ...
              cfg.item_definition.view.get(t.item_id).res_name +
              '.jpg';
