...
!(t => {
  const e = (e => {
    function i() {
      const t = e.call(this, new ui.lobby.rankUI()) || this;
      return (
        (t.root = null),
        (t.title = null),
        (t.tabs = []),
    ...
    (i.prototype.onCreate = function() {
      ...
      for (
        let i = t => {
                const i = n.root.getChildByName('tabs').getChildAt(t);
                (i.clickHandler = new Laya.Handler(n, () => {
    ...
    (i.prototype.setItemValue = function(e, i, n) {
      ...
      if (this.enable) {
        ...
        const l = i.getChildByName('rankscore');
        (l.text = o[
    ...
    (i.prototype.onDisable = function() {
      for (let t = 0; t < this.usedskin.length; t++)
          ...
          app.NetAgent.sendReq2Lobby(
            ...
            (n, a) => {
              if (n || a.error)
                ...
                for (let r = a.items.length, s = 0; s < r; s++)
