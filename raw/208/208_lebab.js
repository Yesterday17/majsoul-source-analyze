...
!(t => {
  const e = (() => {
      ...
      return (e.prototype.show = function(e, i, n) {
        ...
        if (e)
          ...
          const r = (a = cfg.shops.goods.get(i)).currency;
          10 == Math.floor(r / 1e4)
        ...
        const s = cfg.item_definition.item.get(a.item_id);
  ...
  const i = (() => {
    function e(e) {
      ...
      for (
        let n = ['-10', '-1', '+1', '+10'],
            a = t => {
              const e = r.root.getChildByName(n[t]), a = e.getChildByName('s');
              a.alpha = 0;
              let s = false;
              e.on('mousedown', r, () => {
                (a.alpha = 0),
    ...
    (e.prototype.refresh = function() {
      ...
      const e = this.shop_table.buy_limit;
      null != e && e < 0
        ? ((this.buyed.visible = false),
          (this.icon.me.filters = []),
          game.Tools.setGrayDisable(
  ...
  var n = (n => {
    function a() {
      const t = n.call(this, new ui.lobby.shopUI()) || this;
      return (
        (t.money = null),
        (t.tabs = []),
        (t.heads = []),
    ...
    (a.prototype.onCreate = function() {
      ...
      for (
        var a = t => {
            const e = r.container_tab.getChildByName(`btn${t}`);
            r.tabs.push(e),
        ...
        a(s);
      const o = this.container_content.getChildByName('right');
    ...
    (a.prototype.onDisable = function() {
      this.shop_index = -1;
      for (const t in this.usd_item_icon)
    ...
    (a.prototype.refresh_head_show = function() {
      for (let e = 0; e < this.heads.length; e++)
        this.heads[e].visible = this.shop_index == e;
      if (0 == this.shop_index) {
        const i = a.shopinfo.zhp;
        if (i) {
          const n = this.heads[0].getChildByName('refresh'), r = this.heads[0].getChildByName('noinfo'), s = this.heads[0].getChildByName('count');
          if (
            ((n.visible = false),
            (r.visible = false),
            (s.text = ''),
            ...
            const o = cfg.shops.zhp_refresh_price.get(
              i.cost_refresh.count + 1
            );
            if (o) {
              (n.visible = true), (n.getChildByName('free').visible = false);
              const l = n.getChildByName('pay');
              l.visible = true;
              const h = l.getChildByName('count'), c = l.getChildByName('icon'), u = l.getChildByName('money');
        ...
        const d = this.heads[this.shop_index];
    ...
    (a.prototype.render_item = function({index, container, cache_data}) {
      const i = this, n = index, a = container, r = cache_data;
      r.skin ||
