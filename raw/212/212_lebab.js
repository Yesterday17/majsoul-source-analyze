...
!(t => {
  const e = (() => {
      ...
      (e.prototype.move = function(t, e) {
        let i = this.illust.x + t, n = this.illust.y + e;
  ...
  var i = (i => {
    function n() {
      const t = i.call(this, new ui.lobby.susheUI()) || this;
      return (
    ...
    (n.on_data_updata = function({character}) {
      if (character) {
        ...
        if (i.skins) {
          for (const o = i.skins, a = 0; a < o.length; a++)
            this.skin_map[o[a]] = 1;
  ...
  `desc_cv_${GameMgr.client_language}`
    ...
    (n.prototype.say = function(t) {
      const e = this, i = n.characters[this.select_index];
      this.chat_id++;
