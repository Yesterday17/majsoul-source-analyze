...
!(t => {
  const e = (t => {
    function e() {
      const i = t.call(this, new ui.mj.tingpaiUI()) || this;
      return (
    ...
    (e.prototype.onCreate = function() {
      ...
      for (let t = 0; t < this.container_tiles.numChildren; t++) {
        const e = this.container_tiles.getChildAt(t);
        this.items.push({
          container: e,
          tile: e,
    ...
    (e.prototype._show = function(t, e) {
      if (view.DesktopMgr.bianjietishi) {
        ...
        const o = 210 + 80 * t.length + 40 * (t.length - 1);
        (this.bg.bg.width = o),
