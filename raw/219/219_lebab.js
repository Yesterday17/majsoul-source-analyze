...
!(t => {
  ...
  const i = (() => {
    ...
    return (e.prototype.show = function(e, i, n) {
      ...
      const a = cfg.chest.chest_shop.get(e);
      this.my_currency_num = n;
      const r = game.GameUtility.get_item_view(a.item_id);
    ...
    (e.prototype.refresh_cost = function(t) {
      ...
      const e = this.container_price.getChildByName('count');
      (e.text = t.toString()),
    ...
    (e.prototype.on_buy = function() {
      ...
      const e = this.chest_shop_item_id;
  ...
  const n = (() => {
    function e(t) {
      ...
      for (
        let i = ['-10', '-1', '+1', '+10'],
            n = t => {
              const n = a.root.getChildByName(i[t]), r = n.getChildByName('s');
              r.alpha = 0;
              let s = !1;
              n.on('mousedown', a, () => {
                (r.alpha = 0),
    ...
    return (e.prototype.show = function(e, i) {
      (this.chest_shop_item_id = e),
        ...
        (this.me.visible = !0),
        t.UIBase.anim_pop_out(this.root, null);
      const n = cfg.chest.chest_shop.get(e);
      this.single_price = n.price;
      const a = game.GameUtility.get_item_view(n.item_id);
    ...
    (e.prototype.on_buy = function() {
      this.close(), game.Tools.setGrayDisable(this.btn_buy, !0);
      const e = this.chest_shop_item_id, i = this.count;
      app.NetAgent.sendReq2Lobby(
        'Lobby',
        'buyFromChestShop',
        ...
        (n, a) => {
          if (n || a.error)
            ...
            const r = cfg.chest.chest_shop.get(e);
            t.UI_LightTips.Inst.show(
              game.Tools.strOfLocalization(2161, [
  ...
  const a = (() => {
    ...
    return (e.prototype.show = function(e) {
      ...
      (this.chest_id = e),
        ...
        (this.items = []),
        cfg.chest.chest_shop.forEach(({chest_id, check_activity, id, sort}) => {
          chest_id == e &&
            ((check_activity &&
              !t.UI_Activity.activity_is_running(check_activity)) ||
              i.items.push({ id: id, sort: sort }));
        }),
    ...
    (e.prototype.render_item = function({index, container, cache_data}) {
      ...
      const n = index;
      const a = container;
      const r = (cache_data, this.items[n].id);
      const s = cfg.chest.chest_shop.get(r);
      let o = !1;
      game.GameUtility.item_owned(s.item_id) && (o = !0);
      const l = a.getChildByName('btn');
  ...
  const r = (() => {
    function e(t, e) {
      ...
      (this.cells = []),
        ...
        (this.cells = []);
      for (
        let n = this.templete.scriptMap['capsui.UICopy'], a = 0;
        a < 150;
        a++
      ) {
        const r = n.getNodeClone();
        this.cells.push(r);
      }
    ...
    (e.prototype.refresh_data = function(e) {
      const i = this, n = '' != t.UI_Activity.onTreasureRateUp(h.Inst.chest_id);
      ...
      const a = this.content.getChildByName(
      ...
      if (
        ...
        (this.looks = []),
        (this.gifts = []),
        cfg.chest.preview.forEach(({chest_id, check_activity, type, item_id}) => {
          if (
            chest_id == e &&
            (!check_activity ||
              t.UI_Activity.activity_is_running(check_activity))
        ...
        for (
          var r = t => {
              const e = s.charas[t].item_id, n = s.charas[t].check_activity, a = s.cells[s.used_cell_count++];
              s.container_character.addChild(a),
                (a.x = (t % 6) * 162 + 135),
                (a.y = 15 + 175 * Math.floor(t / 6)),
                (a.visible = !0);
              const r = cfg.item_definition.character.find(e), o = cfg.item_definition.skin.find(r.init_skin), l = a.getChildByName('btn');
              (l.clickHandler = Laya.Handler.create(
                s,
                () => {
                  (i.me.visible = !1),
      ...
      if (this.looks.length > 0) {
        ...
        for (
          const l = e => {
                    const i = c.looks[e].item_id, n = c.looks[e].check_activity, a = c.cells[c.used_cell_count++];
                    c.container_look.addChild(a),
                      (a.x = (e % 6) * 162 + 135),
                      (a.y = 15 + 175 * Math.floor(e / 6)),
                      (a.visible = !0);
                    const r = cfg.item_definition.item.find(i), s = a.getChildByName('btn');
      ...
      if (this.gifts.length > 0) {
        ...
        for (
          const u = e => {
                    const i = _.gifts[e].item_id, n = _.gifts[e].check_activity, a = _.cells[_.used_cell_count++];
  ...
  const s = (() => {
    function e(e, i) {
      ...
      for (
        let a = this.head_templete.scriptMap['capsui.UICopy'], r = 0;
        r < 16;
        r++
      ) {
        const s = a.getNodeClone();
        (s.visible = !1), this.head_cells.push(s);
      }
      const o = this.container_right.getChildByName('intro');
    ...
    return (e.prototype.show = function(e, i) {
      ...
      for (
        let a = t => {
                const e = r.head_cells[t];
                if (t < r.charas.length) {
                  const a = r.charas[t].item_id, s = cfg.item_definition.character.find(a), o = cfg.item_definition.skin.find(s.init_skin);
                  e.visible = !0;
                  const l = e.getChildByName('btn');
                  (l.clickHandler = Laya.Handler.create(
                    r,
                    () => {
                      i != t &&
    ...
    (e.prototype._refresh_detail = function(t, e) {
      ...
      this.audio_channel &&
        (this.audio_channel.stop(), (this.audio_channel = null)),
        this.illust.clear();
      const n = cfg.item_definition.character.find(t);
      (this.label_name.text = n[`name_${GameMgr.client_language}`]),
        'chs' == GameMgr.client_language
          ...
          : (this.label_cv.text =
              `CV:${n[`desc_cv_${GameMgr.client_language}`]}`);
      const a = this.intro_content.getChildByName('container_text');
      if (
              ...
              (n.clickHandler = Laya.Handler.create(
                ...
                () => {
                  if (u == e)
                    ...
                    const n = view.AudioMgr.PlayCharactorSound(
                      { charid: t, level: 1 },
                      h[e],
    ...
    (e.prototype._change_choose_target_x = function(t) {
      ...
      if (
        ...
        const i = Math.abs(t - this.container_choose.x) / 0.5;
        Laya.Tween.to(
  ...
  const l = (() => {
    ...
    return (e.prototype.show = function(e) {
      ...
      const n = cfg.exchange.searchexchange.find(this.id);
  ...
  var h = (i => {
    function n() {
      const t = i.call(this, new ui.lobby.treasureUI()) || this;
      return (
        (t.tab_index = 0),
        (t.map_img = {}),
    ...
    (n.prototype.onCreate = function() {
      ...
      for (
        let n = t => {
                const e = r.contianer_content
                  .getChildByName('tabs')
                  .getChildByName(`tab${t}`);
                r.tabs.push(e),
                  (e.clickHandler = new Laya.Handler(r, () => {
      ...
      const h = this.contianer_content.getChildByName('container_shop');
    ...
    (n.prototype.show = function() {
      ...
      const n = t.UI_Activity.onTreasureRateUpRetID(i), a = t.UI_Activity.onTreasureRateUpRetID(i + 2);
      (this.last_seen_up_activity = {}),
        n && (this.last_seen_up_activity[n] = 1),
        a && (this.last_seen_up_activity[a] = 1);
      let r = '';
      for (const s in this.last_seen_up_activity)
        '' != r && (r += ','), (r += s);
    ...
    (n.prototype.change_tab = function(t) {
      ...
      for (let e = 0; e < 2; e++)
        (this.tabs[e].getChildAt(0).skin = game.Tools.localUISrc(
          `myres/treasure/treasure_btn${e}_${e == t ? 'chosed' : 'unchose'}.png`
        )),
    ...
    (n.prototype.refresh_show = function() {
      const e = this;
      let i = 1e3 + 2 * this.tab_index;
      'chs' != GameMgr.client_language && i++, (this.chest_id = i);
      const a = cfg.chest.chest.get(this.chest_id).faith_id;
      this.label_currency.text = n.get_chest_currency(a).toString();
      const r = cfg.chest.chest.get(i), s = t.UI_Activity.onTreasureRateUp(this.chest_id);
      '' != s
      ...
      const u = this.contianer_content.getChildByName('container10');
      if ((h(u), l >= 10)) {
    ...
    (n.prototype.jpproject = function() {
      ...
      const o = this.contianer_content
                .getChildByName('container1')
    ...
    (n.prototype.onDisable = function() {
      for (const t in this.map_img) Laya.loader.clearTextureRes(t);
