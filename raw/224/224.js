    ...
    n = (function(n) {
      ...
      return (
        ...
        (a.prototype._showInfo_mj = function(e) {
          ...
          for (
            var N = function(t) {
                var e = game.Tools.get_chara_audio(n, T[t].sound);
                Laya.timer.once(C, R, function() {
