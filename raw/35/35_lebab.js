...
!(t => {
  const e = (() => {
    ...
    (e.prototype.AddBabei = function(e, i, n) {
      ...
      undefined === n && (n = true);
      try {
        const r = new t.ViewPai(e, t.DesktopMgr.Inst.CreatePai3D(e));
        this.pais.push(r),
          t.DesktopMgr.Inst.showingPaopai &&
            ((r.ismoqie = i),
            (r.ispaopai = t.DesktopMgr.Inst.isPaoPai(r.val))),
          r.OnChoosedPai();
        const s = t.DesktopMgr.Inst.effect_shadow.clone();
        r.model.addChild(s),
        ...
        if (
          ...
          const o = r.model.transform.localPosition.clone();
          const l = r.model.transform.position.clone();
          ...
          const h = t.ModelAnimationController.get_anim_config(
            'Dapai',
