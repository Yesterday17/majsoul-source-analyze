...
!(t => {
  ...
  const i = (() => {
    ...
    (i.init = function() {
      ...
      const e = Laya.LocalStorage.getItem('musicVolume');
      if (e && '' != e) {
        (a = parseFloat(e)) < 0 ? (a = 0) : a > 1 && (a = 1),
          (this._music_volume = a);
      } else this._music_volume = 1;
      const i = Laya.LocalStorage.getItem('yuyinVolume');
      if (i && '' != i) {
        (a = parseFloat(i)) < 0 ? (a = 0) : a > 1 && (a = 1),
          (this._character_all_volume = a);
      } else this._character_all_volume = 1;
      const n = Laya.LocalStorage.getItem('lizhiVolume');
      if (n && '' != n) {
        var a = parseFloat(n);
        a < 0 ? (a = 0) : a > 1 && (a = 1), (this._lizhiVolume = a);
      } else this._lizhiVolume = 1;
      const r = Laya.LocalStorage.getItem('audioMute');
      this._audioMuted = !(!r || '' == r) && 'true' == r;
      const s = Laya.LocalStorage.getItem('musicMute');
      this.musicMuted = !(!s || '' == s) && 'true' == s;
      const o = Laya.LocalStorage.getItem('lizhiMute');
      this._lizhiMuted = !(!o || '' == o) && 'true' == o;
      const l = Laya.LocalStorage.getItem('yuyinMute');
      (this._character_all_mute = !(!l || '' == l) && 'true' == l),
        (this._map_character_mute = {}),
        (this._map_character_volume = {}),
        Laya.timer.frameLoop(1, this, this._update);
    }),
    (i.PlayCharactorSound = function({charid, level}, e, i) {
      const n = charid;
      const a = cfg.item_definition.character.get(n);
      if (!a) return null;
      for (
        var r = level,
    ...
    (i.PlaySound = function(t, e, i) {
      ...
      const a = Laya.SoundManager.playSound(
        t + n,
        1,
    ...
    (i.PlayAudio = function(t, e, i) {
      ...
      if (
        ...
        return -1;
      const a = cfg.audio.audio.get(t);
      if (!a) return -1;
      const r = this._audio_id;
      this._audio_id++;
      const s = this.suffix;

      const o = Laya.SoundManager.playSound(
        a.path + s,
        e,
    ...
    (i._RemoveAudio = function(t) {
      for (let e = 0; e < this._audio_list.length; e++)
        if (this._audio_list[e].id == t) {
          const i = this._audio_list[e];
    ...
    (i.getCVvolume = function(t) {
      if (!this._map_character_volume.hasOwnProperty(t.toString())) {
        const e = Laya.LocalStorage.getItem(`characterVolume${t}`);
    ...
    (i.getCVmute = function(t) {
      if (!this._map_character_mute.hasOwnProperty(t.toString())) {
        const e = Laya.LocalStorage.getItem(`characterMute${t}`);
    ...
    (i._update = function() {
      if (this._music && this._music_state != e.none) {
        const t = Laya.timer.currTimer - this._music_state_starttime;
