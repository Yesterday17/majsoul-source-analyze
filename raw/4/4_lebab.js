...
!(t => {
  const e = (() => {
    function e(i) {
      ...
      for (let a = 0; a < this.container_item.numChildren; a++) {
        const r = this.container_item.getChildAt(a);
        this.items.push({
          me: r,
    ...
    (e.Init = function() {
      ...
      app.NetAgent.sendReq2Lobby('Lobby', 'fetchMailInfo', {}, (e, n) => {
        if (e || n.error) t.UIMgr.Inst.showNetReqError('fetchMailInfo', e, n);
          ...
          if (((i.mails = []), n.mails))
            for (let a = 0; a < n.mails.length; a++) i.mails.push(n.mails[a]);
        ...
        app.NetAgent.AddListener2Lobby(
          ...
          Laya.Handler.create(
            this,
            ({mail_id_list}) => {
              for (let n = 0; n < mail_id_list.length; n++)
                if (i.Inst) i.Inst.onDelMail(mail_id_list[n]);
                  ...
                  for (let s = a; s < e.mails.length - 1; s++)
