...
!(t => {
  ...
  const n = (() => {
    ...
    (t.get_common_view_res_name = function(t) {
      const i = cfg.item_definition.view.get(this.get_common_view_id(t));
      if (i)
    ...
    (t.get_item_view = function(t) {
      ...
      switch (this.get_id_type(t)) {
        case i.currency:
          const r = cfg.item_definition.currency.get(t);
          r &&
          ...
          break;
        case i.character:
          const s = cfg.item_definition.character.get(t);
          s &&
          ...
          break;
        case i.item:
          const o = cfg.item_definition.item.get(t);
          o &&
          ...
          break;
        case i.skin:
          const l = cfg.item_definition.skin.get(t);
          l &&
          ...
          break;
        case i.title:
          const h = cfg.item_definition.title.get(t);
          h &&
