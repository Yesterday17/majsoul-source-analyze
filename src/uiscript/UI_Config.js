...
!(function(t) {
  var e = (function() {
      ...
      return (
        ...
        (i.prototype.onShow = function() {
          ...
          if ('en' == GameMgr.client_language) {
            ...
            (this.contianer_tile_set.visible = false), (this.me.height = 480);
        }),
        i
      );
    })(BaseTabPage),
    ...
    OthersTabPage = (BaseTabPage => {
      class OthersTabPage extends BaseTabPage {
        constructor(m) {
          super(m);
          this.block_other = m.getChildByName('Other');
          this.block_renzheng = m.getChildByName('renzheng');
          this.block_account = m.getChildByName('account');
          this.block_other.getChildByName(
            'btn_gift'
          ...
          this.block_other.getChildByName('jp').visible = false;
          this.block_other.getChildByName('en').visible = false;
          if ('en' == GameMgr.client_language) {
            this.block_other.getChildByName('en').visible = true;
            348;
            this.block_other
              .getChildByName('en')
            ...
            (this.block_other.getChildByName('jp').visible = true),
              429,
              (this.block_other
                .getChildByName('jp')
                .getChildByName('btn0').clickHandler = new Laya.Handler(
          ...
          this.block_account
            ...
            .getChildByName('btn').clickHandler = new Laya.Handler(this, () => {
            h.Inst.locking ||
              (h.Inst.hide(),
        ...
        onShow() {
          ...
          if (
            ...
            const i = this.block_renzheng.getChildByName('RealName');
            const n = i.getChildByName('other');
          ...
          if ('chs' != GameMgr.client_language)
            ...
            GameMgr.Inst.account_data.email_verify
              ? ((s.getChildByName('unbind').visible = false),
                ...
                (s
                  .getChildByName('binded')
                  .getChildByName(
                    'mail'
                  ).text = `(${GameMgr.Inst.account_data.email})`))
      ...
      return (
        ...
        (i.prototype.onCreate = function() {
          ...
          (this.root = this.me.getChildByName('root')),
            ...
            this.pages.push(
              new OthersTabPage(this.panel.getChildByName('OtherCenter'))
            ),
