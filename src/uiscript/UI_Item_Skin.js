  ...
  setSkin(skin) {
    ...
    if (skin != "") {
      if (skin != this.skin_path) {
        ...
        let res_skin = game.LoadMgr.getResImageSkin(skin);
        if (res_skin == "") {
          ...
          game.LoadMgr.loadResImage(
            ...
            Laya.Handler.create(this, () => {
              if (id == _this.change_id) {
                _this.loaded = true;
                _this.img.skin = game.LoadMgr.getResImageSkin(_this.skin_path);
              }
            })
          );
        } else {
...
export default uiscript => (uiscript.UI_Item_Skin = UI_Item_Skin);
