...
module.exports = function(uiscript) {
  let newMoney = (function() {
    function money(e, i, n) {
      var _this = this;
      this.me = e;
    ...
    money.prototype.onEnable = function() {
    ...
    money.prototype.money2Desc = function(t) {
